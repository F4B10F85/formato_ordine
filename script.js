...
function generateProductCode(row) {
  ...
  if (
    cristalli &&
    cristalli !== "SENZA CRISTALLI"
  ) {

    const cristalliIndex =
      coloriCristalli.indexOf(cristalli);

    crystalsCode =
      String(cristalliIndex)
        .padStart(2, "0");
  }
  ...
  if (
    caramella === "Con tassello"
  ) {

    tasselCode = "01";
  }

  return `KT.${articleCode}.${sizeCode}.${leatherCode}.${leavesCode}.${crystalsCode}.${tasselCode}`;
}
